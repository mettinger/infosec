...
# In directory: /mnt/c/Users/jetti/github/python/reverseEng/kaliBinaryInst/triton
#
#  python small_x86-64_symbolic_emulator.py ../frida/fridaQBDITest
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        binaryPath = '/mnt/c/Users/jetti/github/python/reverseEng/kaliBinaryInst/frida/fridaQBDITest'
    ...
    # Load the binary
    binary = loadBinary(ctx, binaryPath)
